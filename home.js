...
const canWeDeliver = (zipCode) => {
    deliveryAreaZipCodes.includes(zipCode) ? console.log(`You're in our delivery zone`) : console.log(`Sorry, we can't deliver to that address`)
}
...
const canWeDeliverTwo = (zipCode) => {
    deliveryAreaZipCodes.forEach(zip => zip === zipCode ? console.log(`You're in our delivery zone`) : console.log(`Sorry, we can't deliver to that address`))
}
